...
export PATH=$PATH:$HOME/.composer/vendor/bin:$HOME/bin:/usr/local/go/bin:$GOPATH/bin:/Applications/MacVim.app/Contents/bin

# Path to your oh-my-zsh installation.
export ZSH=/Users/mball/.oh-my-zsh
...
alias ll="ls -la"
alias rmalldsstore="sudo find / -name \".DS_Store\" -depth -exec rm {} \;"
